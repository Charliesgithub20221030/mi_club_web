# Generated by Django 2.2 on 2019-06-05 10:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_date', models.DateTimeField(auto_now=True)),
                ('entrepreneur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HR.Entrepreneur_content')),
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HR.Post')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='HR.Student_content')),
            ],
        ),
    ]
